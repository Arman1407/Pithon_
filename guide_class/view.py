...
def print_message(msg: str):                     # для печати сообщений
    print('\n' + '=' * len(msg))
    print(msg)
    print('=' * len(msg) + '\n')

def show_book(book: PhoneBook, msg: str):       # для печати справочника или сообщения об ошибке
    if book:
...
def input_contact(msg: list[str]) -> list[str]:        # выводит список контактов
    contact = []
