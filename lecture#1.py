...
# p = range(5) # 0 1 2 3 4 ##(range - элементы списка)
...
# print(len(text)) # определяет размер строки(len - количество элементов)
...
# print(text.replace('лес', 'ЛЕС')) # перводит в заглавный шрифт
