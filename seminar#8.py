...
# initial_phonebook()   : первая запускаемая функция инициализирует телефонную книгу.
# menu()                : отображает доступные пользователю варианты и возвращает введенный выбор.
# add_contact()         : добавляет новый контакт в каталог контактов.
# remove_existing()     : удаляет существующий контакт из каталога контактов.
# delete_all()          : удаляет все контакты из каталога контактов.
# display_all()         : он отображает все контакты из каталога контактов.
# search_existing()     : он выполнит поиск и отобразит существующий контакт в каталоге контактов.
# спасибо ()            :
